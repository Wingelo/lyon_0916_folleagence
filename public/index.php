...
<head>
    ...
    <title>La Folle Agence | Votre communication numérique autrement !</title>
</head>
    ...
    <header>
        ...
        <section class="container-fluid">
            <div class="container">
                ...
                <div class="row">
                    <div class="">
                        <h1>La Folle Agence</h1>
                    </div>
                    <div class="">
                        <h2>Votre communication numérique autrement!</h2>
                    </div>
                </div>
                <div class="row">
                    <div class="">
                ...
                <div class="row">
                    <div class="">
                        <button class="scroll_bottom"></button>
                    </div>
                </div>
                <div class="">
        ...
        <section class="container-fluid">
            <div class="container">
                <div class="row">
                    <div class="">
                        <h3>Qui se cache derrière la Folle Agence ?</h3>
                        <hr>
                    </div>
                </div>
                <div class="row">
                    <div class="">
                        <div class="image_portrait">
                            <img src="">
                        </div>
                    </div>
                    <div class="">
        ...
        <section class="container-fluid">
            <div class="container">
                <div class="row">
                    <div class="">
                        <h3>Discutons de vos projets autour d'un café ?</h3>
                    </div>
                    <div class="">
